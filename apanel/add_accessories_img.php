<?php
	...
	$ctable 	= 'accessories_img';
	$ctable1 	= 'Accessories Image';
	$main_page 	= 'Accessories image'; //for sidebar active menu
	...
	if(isset($_REQUEST['id']) && $_REQUEST['id']>0 && $_REQUEST['mode']=='edit')
	{
		...
		$image_path 		= htmlspecialchars_decode($ctable_d['image_name']);
	}
											...
											<div class="row">
												<div class="col-md-6">
													<label for="rand_image_path">Review Image <code>*</code>
														<!-- <br /> -->
														<small>minimum image size 364 x 498 px</small>
													</label><br/>
													<input type="hidden" name="filename" id="filename" class="form-control" />
													<div id="dropzone_img" class="dropzone" data-width="364" data-height="498" data-ghost="false" data-cropwidth="364" data-originalsize="false" data-url="<?php echo ADMINURL; ?>crop_image.php?img=accessories_img" style="width: 364;height:498;">
