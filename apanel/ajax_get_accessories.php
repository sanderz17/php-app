...
<form action="" name="frm" id="frm" method="post">
    ...
    <input type="hidden" name="hdndb" id="hdndb" value="<?php echo $ctable; ?>">
		<?php
			$db->getDeleteButton();
			$db->getAddButton($page, $ctable1, ADMINURL.'add-'.$page.'/add/'.$_REQUEST['product_id'].'/');
		?>
			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td>
	                		<a href="<?php echo ADMINURL; ?>add-<?php echo $page; ?>/edit/<?php echo $ctable_d['product_id']; ?>/<?php echo $ctable_d['id']; ?>/" title="Edit" class="btn-gradient-dark p-1"><i class="mdi mdi-lead-pencil"></i></a>
