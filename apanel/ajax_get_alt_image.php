			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td><img src="<?php echo SITEURL . PRODUCT . $ctable_d['image_path']; ?>" style="width:100px; height:100px;border-radius: 0;"></td>
						<td>
	                		<a href="<?php echo ADMINURL; ?>add-<?php echo $page; ?>/edit/<?php echo $product_id; ?>/<?php echo $ctable_d['id']; ?>/" title="Edit" class="btn-gradient-dark p-1"><i class="mdi mdi-lead-pencil"></i></a>
