			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td><?php 
						if($ctable_d['isPublished'] == 1)
						{ 
							echo "<div align='center'><a title='Activate' class='p-1' style='pointer-events: none;'><i class='mdi mdi-check'></i></a></div>";
						}
						else
						{ 
							echo "<div align='center'><a title='Not Activate' class='p-1' style='pointer-events: none;'><i class='mdi mdi-close'></i></a></div>";
						} 
						?></td>
						<td>
