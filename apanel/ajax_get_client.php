			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td><img src="<?php echo SITEURL . CLIENT . $ctable_d['logo']; ?>" style="width:50px; height:50px;border-radius: 0;"></td>
						<td><?php if ($ctable_d['type'] == '0') { echo "Partner"; } elseif ($ctable_d['type'] == '1') { echo "Retailer"; } ?></td>
						<td>
