<?php
	...
	$ctable_where .= "isDelete=0";	$item_per_page =  ($_REQUEST["show"] <> "" && is_numeric($_REQUEST["show"]) ) ? intval($_REQUEST["show"]) : 10;
			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td><?php echo $ctable_d['length']; ?></td>
						<td><?php echo $ctable_d['height']; ?></td>
						<td><?php echo $ctable_d['width']; ?></td>
						<td><?php echo $ctable_d['weight']; ?></td>
						<td><?php echo $ctable_d['price']; ?></td>
						<td><?php echo $ctable_d['sell_price']; ?></td>
						<td>
	                		...
	                		<!-- <a href="<?php echo ADMINURL; ?>manage-accessories/<?php echo $ctable_d['id']; ?>/" title="Accessories" class="btn-gradient-dark p-1"><i class="mdi mdi-library-plus"></i></a> -->
	                		<a href="<?php echo ADMINURL; ?>manage-alt-image/<?php echo $ctable_d['id']; ?>/" title="Alternate Images" class="btn-gradient-dark p-1"><i class="mdi mdi-plus"></i></a>
	                		<a href="<?php echo ADMINURL; ?>manage-big-img/<?php echo $ctable_d['id']; ?>/" title="big Images" class="btn-gradient-dark p-1"><i class="mdi mdi-file-image"></i></a>
							<a href="<?php echo ADMINURL; ?>compatible-accessories/<?php echo $ctable_d['id']; ?>/" title="Compatible Accessories" class="btn-gradient-dark p-1"><i class="mdi mdi-attachment"></i></a>
