<?php
	...
	$ctable 	= 'question';
	$ctable1 	= 'Question';
	$main_page 	= 'Question'; //for sidebar active menu
	$page		= 'question';
	...
	if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
		$ctable_where .= " (
			question like '%".$_REQUEST['searchName']."%'
		) AND ";
	}
			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td><?php echo $ctable_d['question']; ?></td>
						<td><?php 
							switch( $ctable_d['question_type'] )
							{
								case 1:
									echo 'Dropdown List'; break;	
								case 2:
									echo 'Radio Buttons'; break;	
								case 3:
									echo 'Checkbox'; break;	
								case 4:
									echo 'Textbox'; break;	
								case 5:
									echo 'Link Section'; break;	
							} ?>
						</td>
						<td>
