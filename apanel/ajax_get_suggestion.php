<?php
	...
	$ctable_r = $db->getData($ctable, "*", $ctable_where, "display_order ASC limit $page_position, $item_per_page");
?>
			...
			<tbody>
				...
				if(@count($ctable_r)>0){
					...
					<tr>
						...
						<td>
	                		<!-- <a href="<?php //echo ADMINURL; ?>link-<?php //echo $page . '/' . $ctable_d['id']; ?>/" title="Links" class="btn-gradient-dark p-1"><i class="mdi mdi-link"></i></a> -->
