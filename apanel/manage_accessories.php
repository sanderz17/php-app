...
<html lang="en">
												...
												<form action="#" onSubmit="return searchByName();">
													<div class="row">
														...
														<div class="col-md-3">
															...
															<button type="button" title="Back" class="btn btn-gradient-light btn-icon-text" onClick="window.location.href='<?php echo ADMINURL; ?>manage-product/'"><i class="mdi mdi-step-backward"></i> </button>
														</div>
													</div>
												</form>
											</div>
	...
	/*Table 1 */
		...
		function displayRecords(numRecords) {
			...
			var data_url    = "<?php echo ADMINURL; ?>ajax_get_<?php echo $page; ?>.php?show=" + numRecords + "&searchName=" + searchName +"&product_id=<?php echo $product_id; ?>";;
			$("#results").html("");
			$(".loading-div").show();
