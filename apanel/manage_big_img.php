...
<html lang="en">
										...
										<div class="box-header with-border">
											<div class="col-md-12 ">
												<form action="#" onSubmit="return searchByName();">
													<input type="hidden" name="prod_id" id="prod_id" value="<?php echo $_REQUEST['prod_id']; ?>">
													<div class="row">
														<div class="col-md-3">
	...
	/*Table 1 */
		...
		function displayRecords(numRecords) {
			...
			prod_id 	    = encodeURIComponent(prod_id.trim());
			var searchName 	= $("#searchName").val();
			searchName 	    = encodeURIComponent(searchName.trim());
			var data_url    = "<?php echo ADMINURL; ?>ajax_get_<?php echo $page; ?>.php?show=" + numRecords + "&searchName=" + searchName+"&prod_id="+prod_id;
			$("#results").html("");
			$(".loading-div").show();
		...
		function del_conf(id,prod_id){
			var r = confirm("Are you sure you want to delete?");
			if(r){
				window.location.href='<?php echo ADMINURL; ?>add-big-img/delete/'+id+'/'+prod_id+'/';
			}
		}
	</script>
</html>