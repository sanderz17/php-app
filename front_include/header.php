...
<!-- Desktop menu Start -->
<input type="hidden" name="SITEURL" id="SITEURL" value="<?php echo SITEURL; ?>">
<header class="header inner-page-bg">
            ...
            <div class="row justify-content-end">
                ...
                <!--                 <div class="col-lg-6">
                    <div class="text-center invisible">
                        <a href="<?php echo SITEURL ?>product/promotions" class="text-decoration-none text-white">
                ...
                <div class="cart-search">
                    <ul>
                        ...
                        <div id="search-overlay" class="block">
                            <div class="search-modal-centered">
                                <div id='search-box'>
                                    ...
                                    <form action='<?php echo SITEURL ?>product_search/' id='search-form' method='post' target='_top'>
                        ...
                        <li class="header-cart">
                            <a href="<?php echo SITEURL; ?>cart/">CART<span class="total_header_cart" id="total_header_cart">
                                    <?php
    ...
    <nav class="mobile-menu-device">
        <div class="row text-center d-lg-none d-none" style="background-color: #cf3e2e;">
            <div class="col-12 p-3">
                <a href="javascript:void(0)"><i class="fa fa-chevron-down text-white mr-3 invisible" data-toggle="collapse" href="#mobileTop" role="button" aria-expanded="false" aria-controls="mobileTop"><span class="ml-3 text-white font-stratum-web-med">Free Gifts with Holiday Orders!</span></i>
