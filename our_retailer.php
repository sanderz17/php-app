...
<html>
    <head>
        <title>Homepage | Retailers</title>
    ...
    <body>
        ...
        <section class="our-partners-section">
            <div class="section-header text-center">
                ...
                <h4>Clear Ballistics is proud to work with these fine retailers.</h4>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <?php 
                        $clients = $db->getData("clients","*","isDelete=0 AND type=1");
                        while($client_data = mysqli_fetch_assoc($clients))
                        {
                        ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="our-partners-section-box">
                            <a href="<?php echo $client_data['link']; ?>">
                                <div class="img-box">
