...
var stickyEl = document.querySelector(".me_sticky"),
    ...
    offset = -20;
window.addEventListener("scroll", function() { window.pageYOffset >= stickyPosition + offset ? (stickyEl.style.position = "fixed", stickyEl.style.top = "0px", stickyEl.style.background = "#292d31") : (stickyEl.style.position = "static", stickyEl.style.top = "", stickyEl.style.background = "") }), AOS.init(), $(document).ready(function() {
